# Form implementation generated from reading ui file 'qtdesigner_screen.ui'
#
...
"background-position: center;")
        ...
        self.push_button_change_color_treemap = QtWidgets.QPushButton(parent=self.formLayoutWidget)
        self.push_button_change_color_treemap.setObjectName("push_button_change_color_treemap")
        self.gridLayout_3.addWidget(self.push_button_change_color_treemap, 7, 0, 1, 1)
        ...
        self.check_box_has_label_treemap = QtWidgets.QCheckBox(parent=self.formLayoutWidget)
        self.check_box_has_label_treemap.setObjectName("check_box_has_label_treemap")
        self.gridLayout_3.addWidget(self.check_box_has_label_treemap, 5, 0, 1, 1)
        self.label = QtWidgets.QLabel(parent=self.formLayoutWidget)
        self.label.setObjectName("label")
        self.gridLayout_3.addWidget(self.label, 0, 0, 1, 1)
        self.push_button_view_treemap = QtWidgets.QPushButton(parent=self.formLayoutWidget)
        self.push_button_view_treemap.setObjectName("push_button_view_treemap")
        self.gridLayout_3.addWidget(self.push_button_view_treemap, 8, 1, 1, 2)
        self.combo_box_color_treemap = QtWidgets.QComboBox(parent=self.formLayoutWidget)
        self.combo_box_color_treemap.setObjectName("combo_box_color_treemap")
        self.gridLayout_3.addWidget(self.combo_box_color_treemap, 7, 1, 1, 2)
        self.combo_box_size_treemap = QtWidgets.QComboBox(parent=self.formLayoutWidget)
        self.combo_box_size_treemap.setObjectName("combo_box_size_treemap")
        self.gridLayout_3.addWidget(self.combo_box_size_treemap, 6, 1, 1, 2)
        self.combo_box_label_treemap = QtWidgets.QComboBox(parent=self.formLayoutWidget)
        self.combo_box_label_treemap.setStyleSheet("")
        self.combo_box_label_treemap.setObjectName("combo_box_label_treemap")
        self.combo_box_label_treemap.addItem("")
        self.combo_box_label_treemap.addItem("")
        self.combo_box_label_treemap.addItem("")
        self.gridLayout_3.addWidget(self.combo_box_label_treemap, 5, 1, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.push_button_change_color_treemap.setText(_translate("MainWindow", "Color:"))
        self.label_2.setText(_translate("MainWindow", "Size:"))
        self.label_3.setText(_translate("MainWindow", "Group Hierarchy:"))
        self.check_box_has_label_treemap.setText(_translate("MainWindow", "Label:"))
        self.label.setText(_translate("MainWindow", "Avaliable Attributes:"))
        self.push_button_view_treemap.setText(_translate("MainWindow", "View Treemap"))
        self.combo_box_label_treemap.setItemText(0, _translate("MainWindow", "New Item"))
        self.combo_box_label_treemap.setItemText(1, _translate("MainWindow", "New Item"))
        self.combo_box_label_treemap.setItemText(2, _translate("MainWindow", "New Item"))
